export default () => {
  return new Promise(function(resolve) {
    resolve({
      landing: {
        title: 'Cześć!',
        description: 'Nazywam się Adaś. Chcesz mi pomóc nie odrywając rąk od klawiatury ?! Wspomóż naszą fundację!'
      },
      foundingResults: {
        title: 'Numerologia',
      ...
      common: {
        ...
        ar: 'العربيّة',
        notif_msg: 'Informujemy, iż w celu realizacji usług dostępnych w naszym sklepie, optymalizacji jego treści, dostosowania sklepu do Państwa indywidualnych potrzeb oraz personalizacji wyświetlanych reklam w ramach zewnętrznych sieci remarketingowych korzystamy z informacji zapisanych za pomocą plików cookies na urządzeniach końcowych użytkowników. Pliki cookies można kontrolować za pomocą ustawień swojej przeglądarki internetowej. Dalsze korzystanie z naszego sklepu internetowego, bez zmiany ustawień przeglądarki internetowej oznacza, iż użytkownik akceptuje stosowanie plików cookies. Więcej informacji zawartych jest w polityce prywatności sklepu.'
      },
      educationLanding: {
        header_home: 'home',
        header_feature: 'main feature',
        header_popular: 'popular course',
        ...
        header_dark: 'dark',
        header_light: 'light',
        banner_title: 'Upgrade Yourself',
        banner_desc:
          'Anywhere, anytime. Start learning today! And Get an Exceptional Education Experience.',
        banner_search: 'Search course...',
        feature_title: 'Main Feature',
        feature_desc: "The world's largest selection of courses",
        counter_videos: 'HD Videos',
        counter_mentors: 'Professional Mentors',
        counter_save: 'Saves per Month',
        counter_free: 'Life Time Access',
        popular_title: 'Popular Course',
        popular_desc:
          'Choose from many options of popular course at a breakthrough price.',
        explore_title: 'Explore Course',
        explore_desc:
        ...
        testimonials_desc: 'They Are Doing Great Things With Us',
        blog_title: "What's update?",
        blog_desc:
          'Up-to-the-minute news, breaking news, video, audio and feature stories',
